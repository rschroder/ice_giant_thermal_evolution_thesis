...
\end{equation}
where z is the altitude, and $C_{P}$ is specific heat.

\subsubsection{Moist Adiabatic Gradient}
Of course, one must also consider the presence of condensible species. When vapor condenses into solid or liquid form, energy is released. This energy is referred to as latent heat

\subsubsection{Radiative Gradient}
