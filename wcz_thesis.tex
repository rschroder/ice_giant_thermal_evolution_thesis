...
\section{Theory on the Structure of Giant Planets}
...
\begin{figure}%
    \centering
    \subfloat[\centering label 1]{{\includegraphics[width=20cm]{figures/cooling/cooling.001.jpeg} }}%
    \qquad
    \subfloat[\centering label 2]{{\includegraphics[width=20cm]{figures/cooling/cooling.002.jpeg} }}%
